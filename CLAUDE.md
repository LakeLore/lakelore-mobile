...
- **Free**: MN. **Paid**: every other active state/province (44 US + 5 CA) via `LakeLore All-States` subscription at **$4.99/yr** auto-renewing. Active states derive from `lakelore-data/registry/states.json` on both server and app.
