...
3. `LakeDetailScreen` — CPUE-over-time chart, stocking history with adults/100ac overlay. Renders in preview mode too (blurred name, county/acres hidden, source links suppressed, unlock banner).
