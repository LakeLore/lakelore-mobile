...
- **Free**: MN. **Paid**: every other state/province (49 US + 6 CA) via `LakeLore All-States` subscription at **$5.99/yr** auto-renewing. Active states derive from `lakelore-data/registry/states.json` on both server and app.
